-- =====================================================
-- Agentes IA — RPCs y ajustes para Edge Functions
-- =====================================================

-- Unique constraint para upserts de costes por agente+fecha
ALTER TABLE ia_costes
ADD CONSTRAINT ia_costes_agente_fecha_unique UNIQUE (agente_id, fecha);

-- Unique constraint para métricas diarias por agente+fecha+ab_version
ALTER TABLE ia_metricas_diarias
ADD CONSTRAINT ia_metricas_diarias_agente_fecha_ab UNIQUE (agente_id, fecha, ab_version);
...
-- Reutiliza la lógica del sistema de reservas existente
...
-- RPC: Match documents for RAG (if not already exists)
-- This is a wrapper around the existing vector search

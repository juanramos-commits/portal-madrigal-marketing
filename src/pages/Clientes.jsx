          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '12px', background: 'rgba(255,255,255,0.03)', borderRadius: '8px' }}>
                ...
                <span style={{ fontSize: '14px', color: 'var(--text)', cursor: 'pointer' }} onClick={() => setNuevoCliente(prev => ({ ...prev, tiene_whatsapp: !prev.tiene_whatsapp }))}>Tiene WhatsApp</span>
              </div>
            </div>
...
// rebuild lunes, 19 de enero de 2026, 19:09:03 CET

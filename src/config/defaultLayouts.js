...
export const DEFAULT_LAYOUTS = {
  admin: [
    ...
    { i: 'table_leads_recientes', type: 'table_leads_recientes', x: 0, y: 8, w: 6, h: 5 },
    { i: 'table_ventas_recientes', type: 'table_ventas_recientes', x: 6, y: 8, w: 6, h: 5 },
    // Row 13-17: Rankings
    { i: 'team_ranking_setters', type: 'team_ranking_setters', x: 0, y: 13, w: 6, h: 5 },
    { i: 'team_ranking_closers', type: 'team_ranking_closers', x: 6, y: 13, w: 6, h: 5 },
  ...
  director_ventas: [
    ...
    { i: 'team_ranking_closers', type: 'team_ranking_closers', x: 6, y: 6, w: 6, h: 5 },
  ...
  closer: [
    ...
    { i: 'chart_ventas_por_dia', type: 'chart_ventas_por_dia', x: 0, y: 2, w: 6, h: 4 },
    { i: 'funnel_closers', type: 'funnel_closers', x: 6, y: 2, w: 6, h: 5 },
    // Wallet row
    ...kpiRow(['kpi_mi_saldo', 'kpi_mi_saldo_disponible', 'kpi_total_ganado', 'kpi_comisiones_pendientes'], 7),
    { i: 'table_ventas_recientes', type: 'table_ventas_recientes', x: 0, y: 9, w: 6, h: 5 },
    { i: 'table_citas_proximas', type: 'table_citas_proximas', x: 6, y: 9, w: 6, h: 5 },
    { i: 'goal_ventas_mes', type: 'goal_ventas_mes', x: 0, y: 14, w: 4, h: 3, config: { objetivo: 15 } },
  ],
  setter: [
    ...kpiRow(['kpi_total_leads', 'kpi_leads_hoy', 'kpi_leads_esta_semana', 'kpi_leads_este_mes'], 0),
    { i: 'chart_leads_por_dia', type: 'chart_leads_por_dia', x: 0, y: 2, w: 6, h: 4 },
    { i: 'funnel_setters', type: 'funnel_setters', x: 6, y: 2, w: 6, h: 5 },
    // Wallet row
    ...kpiRow(['kpi_mi_saldo', 'kpi_mi_saldo_disponible', 'kpi_total_ganado', 'kpi_comisiones_pendientes'], 7),
    { i: 'table_leads_recientes', type: 'table_leads_recientes', x: 0, y: 9, w: 6, h: 5 },
    { i: 'table_leads_sin_contactar', type: 'table_leads_sin_contactar', x: 6, y: 9, w: 6, h: 5 },
    { i: 'goal_leads_mes', type: 'goal_leads_mes', x: 0, y: 14, w: 4, h: 3, config: { objetivo: 50 } },
  ],
}

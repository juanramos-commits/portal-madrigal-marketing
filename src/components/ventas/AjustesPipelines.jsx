  ...
  return (
    <div ref={setNodeRef} style={style} className="aj-etapa-row">
      ...
      <div className="aj-etapa-actions">
        <button className="aj-btn-icon" onClick={() => onEditar(etapa)} title="Editar">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: 14, height: 14 }}>
            <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
          </svg>
        </button>
        {!esSistema && (
          <button className="aj-btn-icon-danger" onClick={() => onEliminar(etapa)} title="Eliminar">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ width: 14, height: 14 }}>
...
export default function AjustesPipelines({
  ...
  return (
    <div className="aj-seccion">
      ...
      <div className="aj-pipeline-tabs">
        {pipelines.map(p => (
          <button
            key={p.id}

  ...
  return (
    <div ref={setNodeRef} style={style} className="aj-etapa-row">
      ...
      <div className="aj-etapa-actions">
        <button className="aj-btn-icon" onClick={() => onEditar(cat)} aria-label="Editar categoría">
        ...
        <button className="aj-btn-icon-danger" onClick={() => onEliminar(cat)} aria-label="Eliminar categoría">
